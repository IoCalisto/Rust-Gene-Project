...
public class ModifyClone
{
    ...
    public boolean depositClone(String cloneName, int amount)
    {
        ...
        try{
            ...
            System.out.println("PING2" + cloneStorage);
            ...
            {
                System.out.println("Could not parse amount from clone...debug readout: ");
                e.printStackTrace();
            }  Integer.parseInt(cloneReader.nextLine())*/

            int currentAmount=cloneReader.nextInt(); //Should read first line and convert to int but doesn't?
            ...
            System.out.println("An error has occurred NAME, AMOUNT:"+cloneName+" "+amount);
            return false;
        }
